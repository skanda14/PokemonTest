...
from battle_2.switch_sub_menu_display import SwitchSubMenuDisplay


class SwitchMenuDisplay:
    def __init__(self, grid_pos, sprite_dict):
        ...
        self.switch_sub_menu_class = SwitchSubMenuDisplay
            ...
            for event in events:
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_SPACE:
                        ...
                        self.current_menu = self.switch_sub_menu_class((11,11), string, self.sprite_dict)
