...
class Pokemon:
    def __init__(self, species, index, types, level=1, exp=0, stats=None, moves=None, name=None, trainer=None, sprite_path=None):
        ...
        self.sprite = pygame.image.load(sprite_path) if sprite_path is not None else None
