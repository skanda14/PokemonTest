...
SCREEN_HEIGHT = 400
FPS = 30
MESSAGE_DURATION = 1500  # Durée d'affichage d'un message en millisecondes (1.5s)
...
class BattleEngine:
    ...
    def draw_message_box(self):
        ...
        if self.current_message:
            ...
            # Barre de progression du timer (visuelle)
            progress = min(1.0, (pygame.time.get_ticks() - self.message_timer) / MESSAGE_DURATION)
            pygame.draw.rect(self.screen, COLOR_GRAY, (0, SCREEN_HEIGHT - 5, int(SCREEN_WIDTH * progress), 5))
    ...
    def advance_message(self):
        # On réinitialise le timer à chaque nouveau message
    ...
    def update(self, screen):
        # Gestion du timer automatique pour les messages
    ...
    def handle_event(self, event):
        ...
        # On permet toujours de passer manuellement avec ESPACE pour plus de confort
